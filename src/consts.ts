...
export const SITE_DESCRIPTION = 'Explorando la intersección entre tecnología, eventos memorables y productividad para el día a día.';

export const WHATSAPP = {
	baseUrl: 'https://api.markentas.com/api/whatsapp',
	messages: {
		default: 'Hola, me contacto desde mialacan.com, quisiera más información sobre las tarjetas digitales',
		invitaciones: 'Hola, me contacto desde mialacan.com/invitaciones, quisiera más información sobre las invitaciones digitales',
		demo: (nombre: string) => `Hola, me contacto desde la tarjeta ${nombre}, me gustó mucho, quisiera más información`,
		cta: '¿Tenés dudas sobre cuál elegir? Escribime y te ayudo a encontrar el diseño perfecto.',
		bienestar: 'Hola, me contacto desde mialacan.com/bienestar, ¿cuál café con Ganoderma me conviene según mi rutina?',
	},
};
...
export const HERO = {
	...
	subtitle: 'Explorando la intersección entre tecnología, eventos memorables y productividad para el día a día.',
};

export const FEATURED = {
	title: '¿Organizas un evento?',
	description: 'Sorprendé con invitaciones digitales interactivas y elegantes. Diseños exclusivos para bodas, 15 años, 18 años y más.',
	ctaText: 'Ver Diseños',
...
export const INVITACIONES_HERO = {
	...
	subtitle: 'Invitaciones digitales con los diseños que vos elegís. Sin complicaciones.',
